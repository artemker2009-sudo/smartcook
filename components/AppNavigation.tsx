...
//
// Хамбургер снят с Главной (этап H11): он дублировал таб-бар и тащил на первый
// экран банкеты с лентой. На остальных экранах, где он ещё используется, список
// пунктов оставлен как был.
//
// Личного кабинета здесь СОЗНАТЕЛЬНО НЕТ: вход в него один — пункт «Профиль» в
// таб-баре, он виден на каждом экране. Пункт в меню был бы вторым входом в то
// же место: человек ищет кабинет, находит два пути и не понимает, одно это или
// разное.
//
