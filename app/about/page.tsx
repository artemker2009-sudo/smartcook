...
export const metadata: Metadata = {
  ...
  description:
    "SmartCook подскажет, что приготовить из продуктов, которые уже есть дома: сфотографируйте их и получите три варианта ужина. Пошаговый режим готовки и списки покупок. Кто делает проект и как с нами связаться.",
