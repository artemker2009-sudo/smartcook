...
export default function Home() {
  ...
  // ДВОЙНАЯ ПЛАШКА (Идеальное выравнивание с переносом)
  const renderUserBadge = (uid: string | undefined | null, level?: number) => {
    ...
    return (
      <>
        {/* Плашка ресторана всегда идет в строку с именем */}
        ...
        {/* Невидимый перенос строки для плашки разработчика */}
        {uid === DEVELOPER_ID && <div style={{ flexBasis: '100%', height: 0, margin: 0, padding: 0 }}></div>}
        
        {/* Плашка разработчика прыгает на новую строку */}
        {uid === DEVELOPER_ID && (
