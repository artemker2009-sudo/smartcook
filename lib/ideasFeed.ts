...
/**
 * Сколько живёт сид. В установленном PWA вкладка не закрывается сутками, и без
 * этого правила лента не перемешалась бы никогда: sessionStorage жив, значит
 * «заход» формально не кончался.
 */
