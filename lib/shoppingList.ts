...
// (в) отделить количество от названия при ПОКАЗЕ строки (lib/shoppingQuantity).
// Экспортируется именно поэтому: второй набор единиц неминуемо разъехался бы с
// этим после первой же правки.
