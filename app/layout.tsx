...
export const viewport: Viewport = {
  // Цвет строки состояния. Раньше был фирменный зелёный, теперь — цвет ВЕРХА
  // первого экрана: шапка с логотипом (белый 85%) поверх фотографии продуктов
  // даёт примерно #ece9e4. Так строка состояния продолжает шапку, а не режет
  // её зелёной полосой.
  themeColor: "#ece9e4",
  width: "device-width",
  initialScale: 1,
